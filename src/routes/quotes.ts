...
router.post("/:id/likes", quotesController.createLikes);
router.delete("/:id/likes", quotesController.deleteLikes);

router.get("/:id/comments", quotesController.getComment);
